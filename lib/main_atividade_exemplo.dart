...
// Rota dinâmica para detalhes do produto, esperando um ID na URL
    GoRoute(
      path: '/produto/:id', // Rota com parâmetro dinâmico
    ...
    return Scaffold(
      body: Center(
        child: ElevatedButton(
          onPressed: () => context.push('/produto/42'), // Vai para a tela de detalhes
