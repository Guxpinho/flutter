            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(15),
                    color: const Color.fromARGB(255, 205, 137, 0),
                  ),
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: const [
                          Text("Tech", style: TextStyle(fontSize: 15, color: Colors.white, fontWeight: FontWeight.bold)),
                          Icon(Icons.contactless, size: 25, color: Colors.white),
                        ],
                      ),
                      const Icon(Icons.sim_card, size: 35, color: Color.fromARGB(255, 255, 187, 0)),
                      const Text("9876 5432 1098 7654", style: TextStyle(fontSize: 25, color: Colors.white, fontWeight: FontWeight.bold)),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: const [
                          Text("titular:", style: TextStyle(fontSize: 10, color: Colors.white)),
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: const [
                          Text("Felipe", style: TextStyle(fontSize: 20, color: Colors.white, fontWeight: FontWeight.bold)),
                          Text("05/28", style: TextStyle(fontSize: 20, color: Colors.white, fontWeight: FontWeight.bold)),
                        ],
                      ),
                    ],
                  ),
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: const [
                          Text("Black", style: TextStyle(fontSize: 15, color: Colors.white, fontWeight: FontWeight.bold)),
                          Icon(Icons.contactless, size: 25, color: Colors.white),
                        ],
                      ),
                      ...
                      Image.asset(
                        'assets/images/chip_black.png',
                        height: 40,
                        errorBuilder: (context, error, stackTrace) => const Icon(Icons.sim_card, size: 40, color: Colors.grey),
                      ),
